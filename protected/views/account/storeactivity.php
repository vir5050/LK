<div class="subhead">
    ...
    <a class="active" href="account/storeactivity" onclick="return go(this, event);"><i data-icon="&#xe093;"></i> <?php echo My::t('app', 'Store Activity'); ?></a>
...
<div class="container-wrapper">
    <?php if(count($storeActivity) > 0): ?>
        <table class="primary-table" style="width: 100%;">
            ...
            <?php foreach($storeActivity as $log): ?>
                <tr>
                    <td><?php echo $i++; ?></td>
                    <td><?php echo Store::model()->findByPk($log['store_id'])->name; ?></td>
                    ...
                    <td style="text-transform: lowercase;"><?php
                        ...
                        echo (isset($data->receiver) ? My::t('app', 'Receiver').': '.$data->receiver.', ': '').(isset($data->count) ? My::t('app', 'Count').': '.$data->count.', ' : '').(isset($data->total_price) ? My::t('app', 'Price').': '.$data->total_price : '');
                    ?></td>
                </tr>
            <?php endforeach; ?>
        </table>
