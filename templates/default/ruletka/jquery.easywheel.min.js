...
!function (e) {
  ...
  t.prototype.option = function (t, r) {
    var n = this;
    if ( - 1 === e.inArray(typeof r, [
      'undefined',
      'function'
    ]) && - 1 === e.inArray(typeof n.o[t], [
      'undefined',
      'function'
    ])) {
      var o = [
  ...
  t.prototype.initialize = function () {
    ...
    if (d.addClass('ew-slicesGroup').appendTo(c), 'string' == typeof t.o.shadow && '' !== e.trim(t.o.shadow)) {
      ...
      e(t.SVG('circle', {
        ...
        r: '50%',
        'stroke-width': '0',
        'fill-opacity': parseInt(t.o.shadowOpacity) < 9 ? '0.' + parseInt(t.o.shadowOpacity)  : 1,
        fill: 'url(#SVGID_1_)'
      })).appendTo(c)
    }
    if (p.appendTo(c), 'v' === t.o.textLine || 'vertical' === t.o.textLine) {
      var f = e('<div/>');
      f.addClass('eWheel-txt-wrap'),
      f.appendTo(s);
      var g = e('<div/>');
    ...
    var y = e('<div/>');
    if (y.addClass('eWheel-center'), y.addClass(t.o.centerClass), y.appendTo(!0 === t.o.rotateCenter || 'true' === t.o.rotateCenter ? s : a), 'string' == typeof t.o.centerHtml && '' === e.trim(t.o.centerHtml) && 'string' == typeof t.o.centerImage && '' !== e.trim(t.o.centerImage)) {
      var v = e('<img />');
    ...
    if ('string' == typeof t.o.centerHtml && '' !== e.trim(t.o.centerHtml)) {
      ...
      parseInt(t.o.centerHtmlWidth) || (t.o.centerHtmlWidth = parseInt(t.o.centerWidth)),
      S.css({
    ...
    e.each(t.items, function (i, a) {
      ...
      if ('v' === t.o.textLine || 'vertical' === t.o.textLine) {
        ...
        var h = '<text stroke-width="0" fill="' + c + '" dy="' + t.toNumber(t.o.textOffset) + '%"><textPath xlink:href="#ew-text-' + i + '" startOffset="50%" style="text-anchor: middle;">' + a.name + '</textPath></text>';
        m.css('font-size', parseInt(t.o.fontSize) / 2),
        parseInt(t.o.letterSpacing) > 0 && m.css('letter-spacing', parseInt(t.o.letterSpacing)),
        m.append(h);
        var f = /(^.+?)L/.exec(l) [1];
        if (!0 !== t.o.textArc) {
          var y = /(^.+?),/,
  ...
  t.prototype.oWithDefaults = function (e) {
    ...
    return void 0 !== e.innerRadius ? t.r1 = e.innerRadius : void 0 !== e.outerRadius ? t.r1 = e.outerRadius - r : t.r1 = 200 - r,
  ...
  t.prototype.brightness = function (e) {
    ...
    n,
    o;
    return e.match(/^rgb/) ? (t = (e = (e = e.match(/rgba?\(([^)]+)\)/) [1]).split(/ *, */).map(Number)) [0], r = e[1], n = e[2])  : '#' == e[0] && 7 == e.length ? (t = parseInt(e.slice(1, 3), 16), r = parseInt(e.slice(3, 5), 16), n = parseInt(e.slice(5, 7), 16))  : '#' == e[0] && 4 == e.length && (t = parseInt(e[1] + e[1], 16), r = parseInt(e[2] + e[2], 16), n = parseInt(e[3] + e[3], 16)),
    o = (299 * t + 587 * r + 114 * n) / 1000,
    o < 125 ? '#fff' : '#333'
  },
  ...
  t.prototype.toObject = function (e) {
    for (var t = {
    }, r = 0; r < e.length; ++r) void 0 !== e[r] && (t[r] = e[r]);
    return t
  },
  t.prototype.WinnerSelector = function () {
    ...
    return 'string' == typeof t.o.selector && (e.each(t.items, function (e, n) {
  ...
  t.prototype.findWinner = function (t, r) {
    ...
    return e.each(n.items, function (e, r) {
  ...
  t.prototype.selectedSliceID = function (t) {
    ...
    } else if ('array' === e.type(r.selected)) !1 !== r.o.selector ? r.selected = e.map(n, function (e, n) {
  ...
  t.prototype.ajax = function (t) {
    ...
    e.ajax(t).done(function (t) {
      ...
      r.nonce && ('string' != typeof t.nonce && console.log('error', 'Nonce Type Incorrect try to use POST Methode with nonce id'), t.nonce !== r.nonce) ? r.o.onFail.call(r.$wheel, r.slice.results, r.spinCount, r.now)  : (void 0 !== t.selector && (r.o.selector = t.selector, r.o.selected = [
        t.winner
      ]), (void 0 === t.stop || !0 !== t.stop && 'true' !== t.stop) && r.run(t.winner))
    })
  },
  ...
  t.prototype.run = function (t) {
    ...
    if (!r.inProgress) {
      if (t || 0 === t) {
        ...
        if (!0 === r.o.random && r.totalSlices() <= r.resetCount && (r.resetCount = 0), void 0 === r.slice.id) return r.resetCount++,
        void r.run(t)
      }
      if (r.inProgress = !0, void 0 !== r.items[r.slice.id]) {
        ...
        r.spinning = e({
          ...
          step: function (t, n) {
            ...
            r.now = t % 360,
            'color' !== e.trim(r.o.type) && r.$wheel.find('.eWheel').css({
            ...
            p = ((r.currentSlice + 1) * i - (1600 - 1600 / 360 * r.now)) / i * 100;
            if (r.slicePercent = p, r.circlePercent = a, r.o.onProgress.call(r.$wheel, r.slicePercent, r.circlePercent), r.lastStep !== r.currentStep) {
              if (r.lastStep = r.currentStep, !0 === r.o.markerAnimation && - 1 === e.inArray(e.trim(r.o.easing), [
                'easeInElastic',
                'easeInBack',
                'easeInBounce',
                'easeOutElastic',
              ...
              'color' === e.trim(r.o.type) ? (r.$wheel.find('svg>g.ew-slicesGroup>path').each(function (t) {
                e(this).attr('class', '').attr('fill', e(this).attr('data-fill'))
              }), r.$wheel.find('svg>g.ew-slicesGroup>path').eq(r.currentSlice).attr('class', 'ew-ccurrent').attr('fill', r.o.selectedSliceColor), r.$wheel.find('.eWheel-txt>.eWheel-title').removeClass('ew-ccurrent'), r.$wheel.find('.eWheel-txt>.eWheel-title').eq(r.currentSlice).addClass('ew-ccurrent'))  : (r.$wheel.find('svg>g.ew-slicesGroup>path').attr('class', ''), r.$wheel.find('svg>g.ew-slicesGroup>path').eq(r.currentSlice).attr('class', 'ew-current'), r.$wheel.find('.eWheel-txt>.eWheel-title').removeClass('ew-current'), r.$wheel.find('.eWheel-txt>.eWheel-title').eq(r.currentSlice).addClass('ew-current')),
          ...
          complete: function (e, t, n) {
            r.inProgress = !1,
            r.o.onComplete.call(r.$wheel, r.slice.results, r.spinCount, r.now)
          }
        }),
        r.counter++,
        r.spinCount++,
  ...
  t.prototype.execute = function () {
    ...
    'string' == typeof t.o.button && '' !== e.trim(t.o.button) && e(document).on('click.' + t.instanceUid, t.o.button, function (e) {
      e.preventDefault(),
      t.start()
    }),
  ...
  e.fn.easyWheel = function () {
    ...
    for (r = 0; r < l; r++) if ('object' == typeof i || void 0 === i ? o[r].easyWheel = new t(o[r], i)  : - 1 !== e.inArray(e.trim(i), c) && (n = 'option' === e.trim(i) ? o[r].easyWheel[i].apply(o[r].easyWheel, a, s)  : o[r].easyWheel[i].apply(o[r].easyWheel, a)), void 0 !== n) return n;
    return o
  }
});
