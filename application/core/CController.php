...
class CController
{
    ...
    function __construct()
    {
        ...
        if($settings !== null){
            $this->view->setMetaTags('title', $settings->meta_title);
            $this->view->setMetaTags('keywords', $settings->meta_keywords);
            $this->view->setMetaTags('description', $settings->meta_description);
            $this->view->_logo = $settings->logo;
            $this->view->_slogan = $settings->slogan;
            $this->view->_footer = $settings->footer;
            unset($settings);
        }
    }
    ...
    {
        $language = My::app()->getRequest()->getQuery('code', 'string');
    ...
    public function redirect($path)
    {
        ...
        $params = '';
        $baseUrl = My::app()->getRequest()->getBaseUrl();
