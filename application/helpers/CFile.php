...
class CFile
{
    ...
    public static function writeToFile($file = '', $content = '', $mode = 'w')
    {
        ...
        @fwrite($fp, $content);
        @fclose($fp);
        self::_errorHandler('file-writing-error', My::t('core', 'An error occurred while writing to file {file}.', array('{file}'=>$file)));
        return true;
    }
    ...
    public static function copyFile($src = '', $destination = '')
    {
        ...
        self::_errorHandler('file-coping-error', My::t('core', 'An error occurred while copying the file {source} to {destination}.', array('{source}'=>$src, '{destination}'=>$destination)));
        return $result;
    }
    ...
    {
        $result = @unlink($file);
        self::_errorHandler('file-deleting-error', My::t('core', 'An error occurred while deleting the file {file}.', array('{file}'=>$file)));
        return $result;
    }
